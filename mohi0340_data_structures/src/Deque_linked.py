...
class _Deque_Node:
    ...
    def __init__(self, value, _prev, _next):
        ...
        -------------------------------------------------------
        """
        # starts off with a copy with the actual value
...
class Deque:
    ...
    def is_empty(self):
        ...
        -------------------------------------------------------
        """
        # if list is empty count will be 0, return True
    ...
    def __len__(self):
        ...
        # we dont use len in linked lists because we cant the length of a
        # linked list
        return self._count
