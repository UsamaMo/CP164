...
class Stack:
    ...
    def _move_top(self, source):
        ...
        # temporary node is equal to top of source stack
        temp = source._top
        # top of source stack is equal to next node
        source._top = source._top._next

        # temporary node is equal to the top of self stack
        temp._next = self._top

        # top of self stack is equal to temporary stack
        self._top = temp
    ...
    def __iter__(self):
        ...
        -------------------------------------------------------
        """
        # current variable equals the top
        current = self._top
