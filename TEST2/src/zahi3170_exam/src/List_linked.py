...
class List:
    ...
    def split_th(self):
        ...
        -------------------------------------------------------
        """
        # splits self list into two parts
        # target 1 contains the first half
        target1 = List()
        # target 2 contains the second half
        target2 = List()

        # length variable is equal to the number of nodes in the list
        length = self.__len__()

        # center is equal to length divided by 2 +1
        center = (length // 2) + 1

        # hare equals front node
        h = self._front

        # for i in range(start from 1, end at center +1)
        for i in range(1, center + 1):
            target1.append(h)
            h = h._next

        for j in range(center + 1, length + 1):
            target2.append(h)
            h = h._next
    ...
    def shuffle(self):
        ...
        -------------------------------------------------------
        """
        # target is another linked list
        target = List()
        # length is equal to the length of self linked list
        length = self.__len__()
        # fill in [None] * length of the linked list
        # if list is 5
